...
open class AuthRepository(
    ...
    private val db: FirebaseFirestore by lazy { db ?: FirebaseFirestore.getInstance() }
    private val functions: FirebaseFunctions by lazy { functions ?: FirebaseFunctions.getInstance() }
